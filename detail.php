...
<body>
    ...
    ?>
    <div class="pb-5 d-flex justify-content-center pt-5 align-items-center">
        <div class="container-xl row p-0">
            ...
            <div class="col-md-6 col-12 pt-3">
                ...
                if ($data['discount'] != 0) {
                ?>
                    <p class="text-dark m-0" style="font-size: 13px;"><del>$<?php echo $data['price']?></del>
                    $<?php echo number_format($data['price'] * (100 - $data['discount']) / 100 , 2)?> <?php echo $data['discount']?>% OFF</p>
                <?php
                } else {
                ?>
                    <p class="text-dark m-0" style="font-size: 13px;"><?php echo $data['price']?></p>
                <?php
                }
                ?>
                <p class="text-dark m-0" style="font-size: 13px;">Stock: <?php echo $data['stock']?></p>
                <p class="text-dark m-0" style="font-size: 13px;">Category: <?php echo $datamenu['name']?>'s Shoes</p>
                <p class="text-dark mt-3 pt-3 border-top" style="font-size: 13px;"><?php echo $data['des']?></p>
                <div><button class="btn btn-success w-100 rounded fs-5 fw-bold my-3">Add to Cart</button></div>
            </div>
        </div>
    </div>
